...
<div style="position:fixed; bottom: 10px; right: 10px; z-index;50; overflow: visible;">
    <div style="border-radius: 12px; padding: 12px; background-color: #0F172A;display: none; position: absolute; bottom: 70px; right: 0; width: 360px; height: 600px;" id="chatbot-${id}">
