...
async function getText(chat_key: string, source_keys: Array<string>, user_id: string, session_id: string) {
...
async function updateText(source_key: string, chat_key: string, text: string, user_id: string, session_id: string) {
