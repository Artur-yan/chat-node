...
\n\nRESTRICTIONS:\n\nDo NOT say \\"Based on the given information.\\nDo not make up answers if you are not sure about the answer. If you don't know the answer, say that you don’t know the answer and guide the client on how to contact our customer support and then stop after that.\\n`,
	userPrompt: '',
	gptVersion: '3.5-june',
	temperature: 0.1,
