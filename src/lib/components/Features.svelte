...
<section class="p-10 md:p-16 lg:p-20 gap-16 2xl:gap-20 grid md:grid-cols-2  lg:grid-cols-3 border-y border-neutral divide divide-neutral bg-base-300">
    <div>
    ...
    <div>
        <h2><Icon icon="devicon:slack" class="text-[#635BFF]" width={24} />Slack integration</h2>
    ...
    <div>
        <h2><Icon icon="basil:lock-solid" class="text-error" width={32} />Public or private</h2>
