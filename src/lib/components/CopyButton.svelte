...
<div class="tooltip tooltip-left" class:tooltip-success={copied} class:tooltip-open={copied} data-tip={copied ? 'Copied!' : 'Copy to clipboard' }>
    <button class="btn btn-ghost btn-sm btn-circle" on:click={() => copyToClipboard(textToCopy)}>
