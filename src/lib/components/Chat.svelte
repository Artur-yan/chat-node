			...
			<div>
				<div class="relative">
					...
					<textarea
						...
						class="textarea textarea-md text-[1rem] placeholder:text-[1rem] min-h-0 max-h-32 w-full leading-5 join-item rounded-lg focus-within:outline-none placeholder:text-[var(--inputText)] {settings.sendButtonEnabled
							? 'pr-12'
							: ''}"
