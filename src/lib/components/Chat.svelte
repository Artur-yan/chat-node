...
<div class="overflow-y-auto scroll-smooth h-full flex-1" bind:this={chatWindow}>
	...
	<form on:submit|preventDefault={submitQuery} class="form-control p-2">
		<div class="text-right text-xs mb-1.5 mr-1 flex justify-end gap-1 items-center leading-none">
			
			<a href="https://www.chatnode.ai" target="_blank">
				<span>Powered by</span> <svg class="inline" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 300 300" fill="none">
