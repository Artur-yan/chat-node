...
<label for="web_scraping" class="btn bg-gradient-to-r from-slate-400 to-slate-600 hover:bg-slate-700 w-full h-full modal-button shadow-lg shadow-zinc-400 hover:shadow-lg hover:shadow-stone-200 hover:-mt-1 border-1 border-slate-600"> 
