...
<section
	class="py-20 bg-[url('/grid.png')] bg-[length:4vw] md:bg-[length:2vw] lg:bg-[length:1vw] relative"
>
	<div
	...
	<div id="features">
			...
			<div>
				<h3>
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
						<path
							fill="currentColor"
							d="m12 13.333l-9.223 6.149A.5.5 0 0 1 2 19.066V4.934a.5.5 0 0 1 .777-.416L12 10.666V4.934a.5.5 0 0 1 .777-.416l10.599 7.066a.5.5 0 0 1 0 .832l-10.599 7.066a.5.5 0 0 1-.777-.416v-5.733Z"
						/>
					</svg>
					Test & Modify Fast
				</h3>
			...
			<div>
				<h3>
					<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
						<path
							fill="currentColor"
							d="M10 2h4v4h-4V2zM7 7h10v2h-2v13h-2v-6h-2v6H9V9H7V7zm-2 4h3V9H5v2zm0 0v2H3v-2h3zm14 0h-2V9h3v2zm0 0h3v2h-2v-2z"
						/>
					</svg>
					Custom Prompts
				</h3>
		...
		<div class="flex flex-wrap items-end justify-center">
			...
			<div>
				...
				<div class="badge clear-both badge-sm badge-outline badge-accent">Coming Soon</div>
				<div class="dot dot-br" />
				<div class="dot dot-tl" />
				<div class="dot dot-tr" />
			</div>
				...
				<h3>
					<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 48 48">
						<path
							...
							stroke-linejoin="round"
							stroke-width="4"
							d="m37 22l-3 3l-11-11l3-3c1.5-1.5 7-4 11 0s1.5 9.5 0 11Zm5-16l-5 5M11 26l3-3l11 11l-3 3c-1.5 1.5-7 4-11 0s-1.5-9.5 0-11Zm12 6l4-4M6 42l5-5m5-12l4-4"
						/>
					</svg>
					API
				</h3>
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
						<g fill="none">
							...
							<path
								stroke="currentColor"
								stroke-width="1.5"
								d="M12 12V8m0 4l3.5 1.5M12 12l-3.5 1.5"
							/>
							<path
								stroke="currentColor"
								stroke-linecap="round"
