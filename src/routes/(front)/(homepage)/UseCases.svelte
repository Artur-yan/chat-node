...
<section class="text-center py-20 container">
	...
	<div
		class="rounded-xl border-neutral border lg:mx-10 text-left flex-wrap gap-6 p-6 flex items-center justify-between"
	>
		<h3 class="text-2xl font-bold">What have you built?</h3>
		<p class="text-lg font-light">Our most creative members get a free month on us.</p>
		<a
			class="btn btn-primary btn-sm btn-outline"
			href="https://discord.gg/R3M5fDk8Rd"
			target="_blank"
		>
