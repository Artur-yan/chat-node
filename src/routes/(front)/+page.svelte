...
<section class="py-20 container !max-w-7xl">
	...
	<div class="grid md:grid-cols-2 divide-x divide-neutral my-10">
		...
		<div class="text-center flex flex-col px-6">
			<div class="mockup-window bg-neutral shadow-lg p-4">
				...
				<div class="flex items-end justify-end">
					<div class="max-w-xs">
						...
						<div class="flex items-center justify-end mt-4">
							<div
								bind:this={arrow}
								class="relative w-12 flex items-center justify-center aspect-square text-4xl text-primary"
...
<div class="py-20 bg-[url('/grid.png')] bg-[length:1vw] relative">
	<div class="absolute inset-0 bg-gradient-to-b from-base-200 via-transparent to-base-200" />
	<div class="flex justify-center">
