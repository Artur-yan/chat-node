...
<div class="card bg-neutral card-compact mb-4">
    ...
    <div class="card bg-neutral card-compact mb-4">
        <div class="card-body">
            ...
            <div class="space-y-4">
                <p class="text-xs">
                    Add specific urls you would like to allow this chatbot to be displayed on.<br>If you leave this blank, you will only be able to share this chatbot via the public url. 
                </p>
