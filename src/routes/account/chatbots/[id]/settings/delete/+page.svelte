...
<div class="alert alert-error text-lg">
    ...
    This action is permanaent. By deleting this chatbot, you will lose all of its data inxluding data you've trained it on, settings and all chat history. Proeed with caution.
